    ...
    Deepak
        ...
        'max-sm:w-0 overflow-hidden' : 'max-sm:w-60 max-sm:pl-10'} max-sm:fixed top-0 bottom-0 right-0 max-sm:min-h-screen
         ...
         max-sm:pt-20 flex sm:items-center gap-5 transition-all`}>
            ...
            <img src={assets.close_icon} alt="" className='w-5 absolute right-4 top-4 sm:hidden' onClick={() => setSidbarOpen(false)} />

            <a onClick={()=> setSidbarOpen(false)} href="#" className='sm:hover:border-b'>Home</a>
            <a onClick={()=> setSidbarOpen(false)} href="#skills" className='sm:hover:border-b'>Skills</a>
            <a onClick={()=> setSidbarOpen(false)} href="#projects" className='sm:hover:border-b'>Projects</a>
            <a onClick={()=> setSidbarOpen(false)} href="#education" className='sm:hover:border-b'>Education</a>
            <a onClick={()=> setSidbarOpen(false)} href="#contact-me" className='sm:hover:border-b'>Contact Me</a>
        </div>
        ...
        <div className='flex items-center gap-2 sm:gap-4'>
            ...
            alt="" onClick={()=> setSidbarOpen(true)} className='w-8 sm:hidden'/>
